                    ...
                    <div className="card-style-form mb-30">
                        ...
                        <div className="card-messages mb-30">
                            <FormControl onSubmit={handleSubmit}>
                                ...
                                <div className="apply-message">
                                    <h5>
                                        Основные требования для получения статуса резидента (Файл для ознакомления №1):
                                    </h5>
                                    <Button>
                                        Yuklab olish
                                    </Button>
                                ...
                                <div className="apply-message">
                                    <h5>
                                        Копии учредительных документов: Устав, Учредительный договор (если учредителей больше одного), Гувохнома:
                                    </h5>
                                    <Button>
                                        Yuklab olish
                                    </Button>
                                ...
                                <div className="apply-message">
                                    <h5>
                                        Описание проекта, предлагаемого для реализации в качестве резидента IТ-парка инноваций в кибернетике (оригинал с живой подписью и печатью):
                                    </h5>
                                    <Button>
                                        Yuklab olish
                                    </Button>
                                ...
                                <div className="apply-message">
                                    <h5>
                                        Копия приказа на директора и его паспорта:
                                    </h5>
                                    <Button>
                                        Yuklab olish
                                    </Button>
                                ...
                                <div className="apply-message">
                                    <h5>
                                        Примерная форма описания проекта (Файл №3):
                                    </h5>
                                    <Button>
                                        Yuklab olish
                                    </Button>
