...
export default function AddReportDialog() {
    ...
    const handleReport = () => {
        ...
        uploadFile(upload, formData).then((response) => {
            if (response.status) {
    ...
    return (
        <div>
            ...
            >
                <DialogTitle>{"Auditorlik hisobotini yuklash"} {user?._id}</DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-slide-description" sx={{ p: 1 }}>
                        ...
                        <MuiFileInput sx={{ my: 1 }} fullWidth value={value} onChange={handleChangeFile} placeholder='file' />
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
