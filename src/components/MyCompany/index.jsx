    ...
    <>
      <div className="main-panel">
        <div className="content-wrapper">
          ...
          "KIBERNETIKADA INNOVATSIYALAR IT-PARKI MCHJ" ? (
            <div className="row">
              <div className="col-lg-12 grid-margin">
                <section className="content-header">
                  <h3>
                    "KIBERNITIKADA INNOVATSIYALART IT-PARKI" MA'SULIYATI
                    CHEKLANGAN JAMIYAT
                  </h3>
                  <ol className="breadcrumb">
                    <button className="btn btn-block">
                      <i className="ti-pencil-alt"></i> Tahrirlash
                    </button>
                  </ol>
                </section>
                <div className="col-lg-12 grid-margin">
                          ...
                          <div className="box-body">
                            <form action="#">
                              <div className="form-group">
                                ...
                                <div className="info-company">
                                  <p>
                                    Ro'yxatdan o'tgan sana / Ro'yhatdan o'tgan
                                    raqami:
                                  </p>
                                ...
                                <div className="info-company">
                                  <p>Faoliyat holati</p>
                                  <label>
                                    Faoliyat ko'rsatayotgan hamda soliq
                                ...
                                <div className="info-company">
                                  <label>
                                    Kompaniyaning ta'sischisi kim (davlatni
                                    ko'rsating)?
                                  </label>
                                ...
                                <div className="info-company">
                                  ...
                                  <p>
                                    Tashkilotning haqiqiy joylashgan manzili:{" "}
                                  </p>
                                  <label></label>
                                </div>
                                <div className="line-div"></div>
                                ...
                                <div className="info-company">
                                  <label>
                                    IT sohasida xalqaro ko'rgazma va forumlarda
                                    ishtirok etish niyatingiz bormi?{" "}
                                  </label>
                                  <div className="custom-button-div">
                                    <button
                                      className="custom-button"
                                ...
                                <div className="info-company">
                                  ...
                                  <div className="info-checkbox">
                                    ...
                                    />
                                    <span>
                                      Xosting va domen registartorlari
                                    </span>
                                  </div>
                                  <div className="info-checkbox">
                                    <input
                        ...
                        <div className="box custom-box">
                          <div className="box-body">
                            <form action="#">
                              <div className="info-company">
                                <h3>
                                  Taqdim etilgan so'ngi hisobotlarga ko'ra
                                    ...
                                    <table className="table table-striped">
                                      <thead>
                                        <tr>
                                          ...
                                          <th>
                                            Hisobot yil bo'yicha o'rtacha
                                            (kishi)
                                          </th>
                                          <th>
                                            Soliq kodeksining 371-moddasi
                                            bo'yicha mehnatga haq to'lash
                                            daromadi, jami (ming so'm)
                                          </th>
                                        </tr>
                                      </thead>
                                      <tbody>
